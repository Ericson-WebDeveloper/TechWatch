...
const Profile = (props: ProfileProps) => {
  ...
  return (
    ...
    //     <div className='flex h-full lg:h-[600px] w-full lg:w-[80%] mx-4 md:mx-0 justify-center mt-5'>
    //         <div className="flex flex-col lg:flex-row w-full lg:w-[80%] bg-white rounded-2xl">
