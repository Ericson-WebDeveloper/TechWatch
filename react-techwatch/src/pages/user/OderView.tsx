                ...
                <div className="flex flex-col w-full space-y-2">
                    <div className="w-full p-6 rounded-2xl shadow-lg bg-white space-y-2">
                        <div className='flex p-3 bg-[rgb(1,192,125)] rounded-xl space-x-4 justify-center items-center'>
                            ...
                            {/* <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vel natus deserunt, itaque esse, blanditiis repellat, explicabo et placeat dolorum 
                                optio perspiciatis doloribus velit! Quidem aut architecto nisi libero, incidunt ipsam.</p> */}
                        </div>
                        {
                            data?.data?.items?.map((item: itemOrder, index:number) => {
                                return  <div className='flex flex-row justify-between items-center border p-2 rounded-3xl' key={index}>
                                            ...
                                            <button type="button" className="w-full px-6 py-2.5
                                                ...
                                                active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Tracking</button>
                                                </Link> */}
                                            </div>
                                        </div>  
                            })
